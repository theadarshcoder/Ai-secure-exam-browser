                            ...
                            <section className="lg:col-span-1 space-y-6">
                                <div className="bg-surface border border-main rounded-3xl p-8 space-y-6 shadow-sm">
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            <div className="flex justify-between text-[11px] font-black text-muted uppercase tracking-widest mb-2"><span>Heap Memory</span><span>{health?.memory ? Math.round(health.memory.heapUsed / 1024 / 1024) : 0}MB</span></div>
                                            <div className="h-2 bg-main rounded-full overflow-hidden"><div className="h-full bg-primary-500 w-[45%] rounded-full shadow-[0_0_8px_rgba(var(--primary-rgb),0.5)]" /></div>
                                        </div>
                                        <div>
                                            <div className="flex justify-between text-[11px] font-black text-muted uppercase tracking-widest mb-2"><span>RSS Usage</span><span>{health?.memory ? Math.round(health.memory.rss / 1024 / 1024) : 0}MB</span></div>
                                            <div className="h-2 bg-main rounded-full overflow-hidden"><div className="h-full bg-indigo-500 w-[60%] rounded-full shadow-[0_0_8px_rgba(99,102,241,0.5)]" /></div>
                                        </div>
                                ...
                                <div className="bg-surface border border-main rounded-3xl p-8 space-y-4 shadow-sm">
                                    <h3 className="text-sm font-bold text-primary flex items-center gap-2"><ShieldCheck size={16} className="text-emerald-500" /> Security Telemetry</h3>
                                    <div className="p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl">
                                        <p className="text-[11px] text-emerald-600 font-medium leading-relaxed italic">All firewall rules active. No intrusion detected in recent socket handshakes.</p>
                                    </div>
                                </div>
                            </section>
